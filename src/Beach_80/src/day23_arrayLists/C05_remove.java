...
public class C05_remove {
    public static void main(String[] args) {
        ...
        java remove method'unda sayi yazdigimizda direk index olrak kabul eder

         */
        System.out.println(sayilar1); // [5, 2, 1]
        //illa da 5'i silmek istiyorsam
        ...
        // 2 yi silmek icin 2'nin indexini bulup onu remove'a yazbiliriz

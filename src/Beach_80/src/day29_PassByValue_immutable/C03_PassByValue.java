package Beach_80.src.day29_PassByValue_immutable;
...
public class C03_PassByValue {
    public static void main(String[] args) {
        ...
        System.out.println("elemanlari degistir methodundan sonra : " + list);// [Oguz, Murat, Fatih]

        listDegistir(list);
        System.out.println("list degistir methodundan sonra : " + list);// [Oguz, Murat, Fatih]
    }
    ...
    public static void elemanlariDegistir(List<String> list) {
        ...
        list.set(1,"Murat");
        list.set(2,"Fatih");
        System.out.println("elemanlari degistir methodunda : " + list);// [Oguz, Murat, Fatih]
    }
}

...
public class C02_StringHavuzu {
    public static void main(String[] args) {
        ...
        new kelimesi kullamilmaz veya
        esitligin saginda bir islem olmazsa Java bakarC

        Eder daha once olusturulan String bire-bir
        ayni String varsa
        o objeyi ve referanslari kullanir.

        bire-bir aynisi yoksa yeni bir obje ve ref olusturur

        "==" hem ref.lari hemde icerigi kontrol ediyor
         */
    }
}
